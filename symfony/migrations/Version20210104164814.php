 ...
 */
final class Version20210104164814 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE files ADD post_id INT DEFAULT NULL, ADD path VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE files DROP post_id, DROP path');
